namespace Doc.Pulse.Contracts.Communications.V1.CodeCategories;

public class CodeCategoryContracts_v1_0
{
    public const string VERSION = "v1.0";
    public const string CONTROLLER_NAME = "CodeCategories";
