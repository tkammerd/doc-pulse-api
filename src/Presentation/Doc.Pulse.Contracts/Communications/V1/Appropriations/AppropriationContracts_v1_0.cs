namespace Doc.Pulse.Contracts.Communications.V1.Appropriations;

public class AppropriationContracts_v1_0
{
    public const string VERSION = "v1.0";
    public const string CONTROLLER_NAME = "Appropriations";
