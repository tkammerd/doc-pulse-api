...
public class CodeCategoryHardDeleteHandler
{
    public class Request : IRequest<Response>
    {
        public required CodeCategoryHardDeleteCmd Command { get; set; }
    }
    public class Response : MediatorResult<CommandResponse> { }

    public class Validator : AbstractValidator<CodeCategoryHardDeleteCmd>
    {
        public Validator()
        {
