...
public class AppropriationHardDeleteHandler
{
    public class Request : IRequest<Response>
    {
        public required AppropriationHardDeleteCmd Command { get; set; }
    }
    public class Response : MediatorResult<CommandResponse> { }

    public class Validator : AbstractValidator<AppropriationHardDeleteCmd>
    {
        public Validator()
        {
