...
public class AccountOrganizationGetByIdHandler
{
    public class Request : IRequest<Response>
    {
        public required AccountOrganizationGetByIdQry Query { get; set; }
    }
    public class Response : MediatorResult<AccountOrganizationGetByIdResponse> { }
    ...
    public class MapperProfile : Profile
    {
        ...
        {
            CreateMap<AccountOrganization, AccountOrganizationGetByIdResponse>();
        }
    }
    ...
    public class Handler(AppDbContext dbContext, IMapperAdapter mapper) : HandlerBase<AppDbContext, Request, Response>(dbContext, mapper)
    {
        public async override Task<Response> Handle(Request request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                var dto = _mapper.Map<AccountOrganizationGetByIdResponse>(entity);
                if (dto == null)
