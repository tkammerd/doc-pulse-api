...
public class AccountOrganizationHardDeleteHandler
{
    public class Request : IRequest<Response>
    {
        public required AccountOrganizationHardDeleteCmd Command { get; set; }
    }
    public class Response : MediatorResult<CommandResponse> { }

    public class Validator : AbstractValidator<AccountOrganizationHardDeleteCmd>
    {
        public Validator()
        {
