...
public class ReceiptHardDeleteHandler
{
    public class Request : IRequest<Response>
    {
        public required ReceiptHardDeleteCmd Command { get; set; }
    }
    public class Response : MediatorResult<CommandResponse> { }

    public class Validator : AbstractValidator<ReceiptHardDeleteCmd>
    {
        public Validator()
        {
