...
using Doc.Pulse.Api.Features.Appropriations.Commands;
using Doc.Pulse.Api.Features.Appropriations.Queries;
...
[ApiVersion("1.0")]
public class AppropriationsController(ILogger<AppropriationsController> logger, IMediator mediator) : BaseApiController(mediator)
{
    private readonly ILogger<AppropriationsController> _logger = logger;

    [HttpGet]
    public async Task<IActionResult> List()
    {
        var result = await _mediator.Send(new AppropriationListHandler.Request()
        {
            Query = new AppropriationListQry()
        });
        return result.ToActionResult();
    }

    /// <summary>
    /// Get Paginated List of Appropriations
    /// </summary>
    /// <param name="query">Id property within AppropriationGetByIdQry query</param>
    /// <remarks>
    ...
    ///     </ul>
    /// </remarks>
    /// <returns>A list of Appropriation values</returns>
    [HttpGet]
    public async Task<IActionResult> ListPaginated([FromQuery] AppropriationListQry query)
    {
        var result = await _mediator.Send(new AppropriationPaginatedListHandler.Request() { Query = query });
        return result.ToActionResult();
    }
...
#pragma warning disable ASP0018 // Unused route parameter
    ...
    /// <summary>
    /// Get Simple Appropriation
    /// </summary>
    /// <param name="Id">Value of AppropriationId to get</param>
    /// <paramref name="query">AppropriationGetByIdQry parameter containing Id property</paramref>
    /// <remarks>
    /// The property specified in the route will be automatically found within the method parameters if their names do not match.
    /// In this endpoint, <i>Id</i> will be found within the AppropriationGetByIdQry parameter <i>query</i>.<br/>
    /// The value returned is in a the default response wrapper with extensions.
    /// </remarks>
    /// <returns>The value of the Appropriation with the specified Id</returns>
    [HttpGet("{Id}", Name = "Get Simple Appropriation by id")]
#pragma warning restore CS1572  // XML comment has a param tag, but there is no parameter by that name
#pragma warning restore ASP0018 // Unused route parameter
    public async Task<IActionResult> GetById([FromRoute] AppropriationGetByIdQry query)
#pragma warning restore CS1573  // Parameter has no matching param tag in the XML comment (but other parameters do)
    {
        var result = await _mediator.Send(new AppropriationGetByIdHandler.Request() { Query = query });
        return result.ToActionResult();
    }

    [HttpPost]
    public async Task<IActionResult> Create([FromBody] AppropriationCreateCmd command)
    {
        var result = await _mediator.Send(new AppropriationCreateHandler.Request() { Command = command });
        return result.ToActionResult();
    }

    [HttpPost]
    public async Task<IActionResult> HardDelete([FromBody] AppropriationHardDeleteCmd command)
    {
        var result = await _mediator.Send(new AppropriationHardDeleteHandler.Request() { Command = command });
        return result.ToActionResult();
    }

    [HttpPost]
    public async Task<IActionResult> Update([FromBody] AppropriationUpdateCmd command)
    {
        var result = await _mediator.Send(new AppropriationUpdateHandler.Request() { Command = command });
        return result.ToActionResult();
    }
...
#pragma warning disable ASP0018 // Unused route parameter
                                // Justification: Swagger finds param "Id" as a property of param "query"
    /// <summary>
    /// Get Appropriation without extensions
    /// </summary>
    /// <param name="Id">Value of AppropriationId to get</param>
    /// <paramref name="query">AppropriationGetByIdQry parameter containing Id property</paramref>
    /// <remarks>
    ...
    /// </remarks>
    /// <returns>The value of the Appropriation with the specified Id</returns>
    [HttpGet("raw/{Id}", Name = "Get Appropriation by id without extensions")]
#pragma warning restore CS1572  // XML comment has a param tag, but there is no parameter by that name
#pragma warning restore ASP0018 // Unused route parameter
    public async Task<IActionResult> GetById_WithoutExtensions([FromRoute] AppropriationGetByIdQry query)
#pragma warning restore CS1573  // Parameter has no matching param tag in the XML comment (but other parameters do)
    {
        try
        {
            ...
            {
                var response = new ApiResponse<AppropriationGetByIdResponse>()
                {
